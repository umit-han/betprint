...
export const metadata: Metadata = {
  title: "Impressum",
  description: "Impressum für Betprint, eine Marke der YILDIZ Commercial GmbH. Gesetzlich vorgeschriebene Angaben gemäß § 5 TMG.",
  keywords: ["Impressum", "Betprint", "YILDIZ Commercial GmbH", "Kontakt", "Registereintrag", "Umsatzsteuer-ID", "Streitbeilegung"],
  alternates: {
    canonical: "https://www.betprint.de/impressum",
  },
};
