...
export const metadata: Metadata = {
  title: "Über uns | Betprint - Ihr Spezialist für Thermorollen",
  description: "Erfahren Sie mehr über Betprint, Ihren Spezialisten für nachhaltige und hochwertige Thermorollen für Wettbüros. Produziert in Deutschland, frei von Bisphenolen und Phenolen.",
  keywords: ["Betprint", "Über uns", "YILDIZ Commercial GmbH", "Thermorollen", "Wettbüros", "Nachhaltige Produkte", "Hochwertige Qualität", "Made in Germany", "Bisphenolfrei", "Phenolfrei"],
  alternates: {
    canonical: "https://www.betprint.de/terms",
  }
};
