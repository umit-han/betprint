            ...
            <ul className="mt-9 flex items-center space-x-3">
              <li>
                <a
                  ...
                  title="Besuchen Sie unser Twitter-Profil"
                ...
                >
                  ...
                  <span className="sr-only">Besuchen Sie unser Twitter-Profil</span>
                </a>
              </li>
              ...
              <li>
                <a
                  ...
                  title="Besuchen Sie unser Facebook-Profil"
                  className="flex size-7 items-center justify-center rounded-full bg-foreground text-background transition-all duration-200 hover:bg-primary focus:bg-primary"
                  target="_blank"
                >
                  <svg
                  ...
                  <span className="sr-only">Besuchen Sie unser Facebook-Profil</span>
                </a>
              </li>
              ...
              <li>
                <a
                  ...
                  title="Besuchen Sie unser Instagram-Profil"
                  className="flex size-7 items-center justify-center rounded-full bg-foreground text-background transition-all duration-200 hover:bg-primary focus:bg-primary"
                  target="_blank"
                >
                  <svg
                  ...
                  <span className="sr-only">Besuchen Sie unser Instagram-Profil</span>
                </a>
              </li>
            </ul>
          </div>
